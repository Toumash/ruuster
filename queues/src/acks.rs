...
/// let msg = Message { uuid : "teepot".to_string(), payload: "#badcaffe".to_string(), metadata: None}; // fake message with hardcoded uuid
///
...
///
/// let msg = Message { uuid : "teepot2".to_string(), payload: "#badcaffe".to_string(), metadata: None};
/// acks.add_record(msg.clone(), Duration::from_millis(100));
